...
public val ChatHeart: ImageVector
    get() {
        if (_ChatHeart != null) {
            return _ChatHeart!!
        }
        _ChatHeart = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.287f, -0.801f)
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.088f, -0.272f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.711f, 0.074f)
                curveToRelative(-0.387f, 0.196f, -1.24f, 0.57f, -2.634f, 0.893f)
                arcToRelative(11f, 11f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.398f, -2f)
                moveToRelative(-0.8f, 3.108f)
                lineToRelative(0.02f, -0.004f)
                curveToRelative(1.83f, -0.363f, 2.948f, -0.842f, 3.468f, -1.105f)
                arcTo(9f, 9f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8f, 15f)
                ...
                arcToRelative(10.4f, 10.4f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.524f, 2.318f)
                lineToRelative(-0.003f, 0.011f)
                arcToRelative(11f, 11f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.244f, 0.637f)
                curveToRelative(-0.079f, 0.186f, 0.074f, 0.394f, 0.273f, 0.362f)
                arcToRelative(22f, 22f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.693f, -0.125f)
                moveTo(8f, 5.993f)
